...
//get minimium from a stack with complexity O(1)
/*
create a auxiliary stack that maintains minimium of all values in the stack
when we pop the stack, pop the minStack too.
when we push the main stack , push either the new element or the current minimium
 */
